                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
						...
						<div class="card shadow mb-5">
	                        ...
	                        <div class="card-body">
								<form method="post">
								  <input type="hidden" name="boardNum" value="${product.productNum}"> <!-- EL을 사용했기 때문에 Exception 발생 X -->
								  ...
								  <div class="form-group">
								    ...
								    <input type="text" class="form-control" id="category" name="productCategory">
								  </div>
								  <div class="form-group">
								  ...
								  <div class="form-group">
								    ...
								    <textarea class="form-control" id="contents" name="productContents">${dto.boardContents}</textarea>
								  </div>
